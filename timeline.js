  ...
  var items = new vis.DataSet([
    ...
    {id: 5, content: 'Employee of the Year(Nominated)', start: '2014-01-01',style:"color:white;background-color: #2962FF;border:0px"},
    {id: 6, content: 'Manager Data Analytics(M2), Nations Trust Bank', start: '2014-01-02', end: '2017-07-01',style:"color:white;background-color: #20A5C0;border:0px"},
    {id: 7, content: 'Consumer Loans Manager(M1), Nations Trust Bank', start: '2012-05-01', end: '2013-12-31',style:"color:white;background-color: #20A5C0;border:0px"},
